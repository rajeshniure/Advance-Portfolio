...
const items: ItemType[] = [
  ...
  id: 2,
  title: "Cine Verse",
  img: "/assets/projects/CineVerse.jpg",
  desc: "CineVerse is a modern movie and TV streaming web app built with React, TypeScript, and Material UI.It features dynamic routing, search functionality, and a login/signup system, offering users a seamless and engaging entertainment experience.",
  url: "https://github.com/rajeshniure/cineVerse",
  live: "https://cine-verse-ten-zeta.vercel.app/",
    },
  {
    id: 3,
